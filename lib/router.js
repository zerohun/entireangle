...
Router.route('/posts', {
  ...
  subscriptions: function(){
      ...
      window.postsSubscription = Meteor.subscribe("posts", limit);
      return window.postsSubscription;
  },
  data: function(){
      var limit = parseInt(this.params.query.postsLimit) || 10;
      return {
...
Router.route('/posts/:_id', {
  ...
  waitOn: function () {
    ...
    if(window.postsListSubscription)
        return window.postsListSubscription;
    else
